...
const CompaniesChart = ({ companiesAnalytics, handleDateChange }: any) => {
  const _datasets = companiesAnalytics?.datasets?.map((value: any) => ({
    ...value,
  ...
  const data = {
    labels: companiesAnalytics?.labels,
    datasets: _datasets,
  }
  ...
  return (
    <>
      <Row justify="space-between" align="middle" className="mb-9">
        <Col flex="none">
          <span className="fowe900 text16">Companies</span>
        </Col>
